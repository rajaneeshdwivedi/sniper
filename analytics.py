...
"""
Precision Metrics Generator

This module generates precision-focused metrics for model evaluation,
including low volume precision metrics, confidence calibration, and
...
def generate_precision_metrics(prediction_scores, targets, metadata_df=None, save_dir=None):
    ...
    for pct in volume_percentages:
        ...
        # Calculate precision gain (relative to baseline)
        ...
        threshold = float(volume_scores[-1])
    ...
    # Calculate confidence metrics if confidence scores are available
    confidence_metrics = {}
